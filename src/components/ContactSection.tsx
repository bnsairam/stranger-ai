    ...
    <section id="contact" className="relative py-20 md:py-32 px-5 md:px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <PhoneIcon size={15} className="text-primary/60 group-hover:text-primary transition-colors" />
      ...
      >
        ...
        <p className="font-display text-xs md:text-sm text-muted-foreground/70 tracking-[0.2em] md:tracking-[0.3em]">
          JEPPIAAR ENGINEERING COLLEGE
        </p>
        <p className="font-body text-[10px] md:text-xs text-muted-foreground/40 mt-2 tracking-[0.3em] md:tracking-[0.4em] uppercase">
