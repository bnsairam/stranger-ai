...
const CoordinatorsSection = () => {
  ...
  return (
    <section ref={sectionRef} id="coordinators" className="relative py-20 sm:py-28 md:py-36 px-4 sm:px-5 md:px-8 overflow-hidden">
      {/* Ambient glows */}
      <motion.div
        className="absolute top-1/4 left-0 w-[300px] sm:w-[400px] md:w-[500px] h-[400px] sm:h-[500px] md:h-[700px] -translate-y-1/2 rounded-full blur-[150px] sm:blur-[200px] md:blur-[220px] pointer-events-none"
        style={{ x: glowX, opacity: glowOpacity, background: `hsl(280 60% 45% / 0.07)` }}
      />
      <motion.div
        className="absolute bottom-1/3 right-0 w-[250px] sm:w-[300px] md:w-[400px] h-[350px] sm:h-[450px] md:h-[600px] rounded-full blur-[150px] sm:blur-[180px] md:blur-[200px] pointer-events-none"
        style={{
      ...
      {/* Section fades */}
      <div className="absolute top-0 left-0 right-0 h-20 sm:h-32 md:h-40 bg-gradient-to-b from-background to-transparent pointer-events-none z-[5]" />
      <div className="absolute bottom-0 left-0 right-0 h-20 sm:h-32 md:h-40 bg-gradient-to-t from-background to-transparent pointer-events-none z-[5]" />
          ...
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                ...
                {/* Card body */}
                <div
                  className={`relative card-stranger p-4 sm:p-5 md:p-6 pb-8 sm:pb-10 md:pb-12 overflow-hidden transition-shadow duration-[900ms] ${
                    isAccent
                ...
                >
                  ...
                  <div className="absolute top-0 right-0 w-10 sm:w-14 h-10 sm:h-14 pointer-events-none">
                    <div
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    <div
                      className={`flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-sm border transition-all duration-[700ms] ${
                        isAccent
                    ...
                    <h3
                      className={`font-cinzel text-xs sm:text-sm md:text-base tracking-wide transition-colors duration-[700ms] font-semibold ${
                        isAccent
                  ...
                  {/* Divider */}
                  <div
                    className={`h-[1px] mb-3 sm:mb-4 transition-all duration-[800ms] ${
                      isAccent
                        ? "w-8 sm:w-10 bg-accent/15 group-hover:w-full group-hover:bg-accent/25"
                        : "w-8 sm:w-10 bg-primary/15 group-hover:w-full group-hover:bg-primary/25"
                    }`}
                  />
                  ...
                  >
                    {cat.members.map((name, i) => (
                      ...
                      >
                        <span
                          className={`mt-[6px] sm:mt-[7px] w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full shrink-0 transition-all duration-500 ${
                            isAccent
                              ? "bg-accent/30 group-hover:bg-accent/60"
                              : "bg-primary/30 group-hover:bg-primary/60"
                          }`}
                        />
                        <span className="font-body text-xs sm:text-sm md:text-[15px] text-foreground/75 group-hover:text-foreground/90 transition-colors duration-500 leading-relaxed tracking-wide">
                          {name}
                        </span>
                      </motion.li>
                    ))}
                  ...
                  {/* Member count badge */}
                  <div
                    className={`absolute bottom-3 sm:bottom-4 right-4 sm:right-5 font-montserrat text-[9px] sm:text-[10px] tracking-[0.25em] sm:tracking-[0.3em] uppercase transition-all duration-[700ms] font-medium ${
                      isAccent
